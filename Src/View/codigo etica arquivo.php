 ...
 * ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
 * ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
 * ║  │ @description: View of the file                                                                              |  ║
 * ║  │ @class: codigo etica arquivo                                                                                │  ║
 * ║  │ @dir: Src/ View                                                                                             │  ║
...
$nome_arquivo = $CodigoEtica_Colaborador_repositorio->consultar_NomeArquivo($codigo);

$link = "https://www5.pe.senac.br/Termo-de-compromisso/src/Email/documentos/" . $nome_arquivo;
...
<div class="row" style="background-color: white; height:19.5cm;">
    <section>
      <article class="card">
        <a href="codigo etica fim_processo.php">Voltar</a>
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            <h2 class="content_inicioText">Comprovante do aceite do código de ética de:</h2>
            <h2 class="content_inicioText" style="color: red;"><?php echo $nome_colaborador; ?> </h2>
            <h4 class="content_inicioText">Abaixo se encontra uma cópia do arquivo de finalização do processo.</h4>
          </div>
        </div>
      </article>
      ...
      <article class="card content_textLeft">
          ...
          <h5>Clique <a target="_blank" href="<?php echo $link; ?>">aqui</a> para visualizar o comprovante de aceite. </h5>
