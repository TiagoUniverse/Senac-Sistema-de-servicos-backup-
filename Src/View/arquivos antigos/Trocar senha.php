 ...
 * ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
 * ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
 * ║  │ @description: Screen to change the password                                                                 │  ║
 * ║  │ @class: Trocar senha                                                                                        │  ║
 * ║  │ @dir: Html Website                                                                                          │  ║
      ...
      <article class="card">
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            ...
            <h5>Digite a sua nova senha duas vezes e clique em alterar para salvar sua nova senha</h5>

            <?php
            if (isset($_POST['senha']) != null && isset($_POST['senhaRepetida']) != null) {

              if ($_POST['senha'] != $_POST['senhaRepetida']) {
            ?>
                <h3 class="fundoVermelho"> As senhas digitadas não são iguais. Por favor, tente novamente.</h3>
              <?php
              } else {

                $Usuario_repositorio = new Usuario_repositorio();

                $Usuario_repositorio->alterarSenha($_POST['senha'], $_SESSION['idUser']);
              ?>
                <h3 class="fundoVerde">Senha alterada com sucesso!</h3>
            <?php
              }
            }
      ...
      <article class="card content_textLeft">
        <form action="Trocar senha.php" method="POST">
          ...
          <div class="form-floating">
            ...
            <input type="password" class="form-control" name="senhaRepetida" id="senhaRepetida" required>
            <div class="valid-feedback">
              Muito bem!
            </div>
          </div>
