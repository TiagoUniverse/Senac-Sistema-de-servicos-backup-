 ...
 * ║  │ @class: codigo etica fim_processo                                                                           │  ║
 * ║  │ @dir: Html Website/                                                                                         │  ║
...
function CriarTela(array $resultado_Listagem)
{
  ...
  // Contagem de quantas pessoas realmente foram exibidas
  $contadorPessoas = 0;
  ...
  foreach ($parteArray as $resultado) {
    ...
    if ($resultado[0] != 0) {
      echo "
                  ...
                  <form action='codigo etica arquivo.php' method='POST'>
                    <li>
                      <input name='id_usuario' value='" . $resultado[0] . "' type='hidden'> </input>
                      <input name='nome_colaborador' value='" . $resultado[1] . "' type='hidden'> </input>
                      <button type='submit' class='dropdown-item'>
...
<head>
  ...
  <title>Resultados do código de ética</title>
    ...
    <article class="card box_shadow">
      <div class="row g-0 text-center">
        ...
        <div class="col-sm-6 col-md-8" id="content_inicio">
          <h2 class="content_inicioText">Resultados do Código de ética</h2>
          <h5 class="content_inicioText">Visualize os processos finalizados dos colaboradores. Caso precise, utilize o filtro para localizar um colaborador.</h5>
        </div>
        ...
        <div class="container text-center">
          <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
            ...
            ?>
              <div class="col">
                <div class="p-3 ">
                  <form action="codigo etica fim_processo.php" method="POST">
