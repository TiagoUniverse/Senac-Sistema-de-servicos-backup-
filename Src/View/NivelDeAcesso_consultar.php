...
* ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
* ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
* ║  │ @description: View of informations of the 'Nivel de acesso' class                                           │  ║
* ║  │ @class: NivelDeAcesso_consultar                                                                             │  ║
* ║  │ @dir:  View/                                                                                         │  ║
...
$codigo = $_POST['id_NivelDeAcesso'] ?? $_GET['id_NivelDeAcesso'];
...
<head>
  ...
  <title>Consulta de nível de acesso</title>
    ...
    <section>
      <article class="card">
        ...
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            <h2 class="content_inicioText">Consulta de um nível de acesso</h2>
          </div>
        </div>
      </article>
      ...
      <article class="card content_textLeft">
        ...
        <div class="form-floating">
          <input type="text" class="form-control my-2" value="<?php echo $NivelDeAcesso->getNome(); ?>" disabled id="nome" placeholder="Nome">
          <label for="floatingPassword">Nome </label>
        </div>

        <div class="form-floating">
          <input type="date" class="form-control my-2" value="<?php echo $NivelDeAcesso->getCreated(); ?>" disabled id="email" placeholder="Email">
        ...
        <br>
        <div class="form-floating">
          <input type="email" class="form-control my-2" value="<?php echo $NivelDeAcesso->getDescricao(); ?>" disabled id="descricao" placeholder="descricao">
