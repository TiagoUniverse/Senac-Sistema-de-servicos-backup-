 ...
 * ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
 * ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
 * ║  │ @description: Registry of the new 'Unidade' object                                                          │  ║
  ...
  ?>
    ...
    <section>
      ...
      <article class="card content_textLeft">
        <form action="Unidade_cadastro2.php" method="POST">
          <label for="basic-url" class="form-label">Informações de contato</label>

          <div class="form-floating">
            <label for="validationCustom01" class="form-label">Nome da unidade:</label>
          ...
          <br>
          <div class="form-floating">
            <label for="validationCustom01" class="form-label ">Descrição da unidade:</label>
