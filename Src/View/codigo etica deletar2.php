 ...
 * ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
 * ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
 * ║  │ @description: Result of Delete of a register                                                                │  ║
 * ║  │ @class: codigo etica deletar2                                                                               │  ║
 * ║  │ @dir: View/                                                                                                 │  ║
...
$retorno = $CodigoEtica_Colaborador_repositorio->excluir_solicitacao($id_usuario);

if ($retorno) {
  $mensagem = "Exclusão da solicitação com sucesso!";
} else {
  $mensagem = "Falha na exclusão. Por favor, tente novamente.";
}
      ...
      <article class="card">
        ...
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            <h2 class="content_inicioText">Exclusão de solicitação de um colaborador</h2>
            <br>
