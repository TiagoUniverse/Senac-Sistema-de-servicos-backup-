 ...
 * ║  │ @class: codigo etica reenviar_aceite                                                                        │  ║
 * ║  │ @dir: Src/ View                                                                                             │  ║
...
<head>
  ...
  <title>Reenviar email de código de ética</title>
      ...
      <article class="card">
        ...
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            <h2 class="content_inicioText">Reenviar e-mail de aceite do código de ética</h2>
            <h2 class="content_inicioText" style="color: red;"><?php echo $nome_colaborador; ?> </h2>
            <h4 class="content_inicioText">Ao cliclar no botão, o sistema enviará um e-mail de aceite do código de ética para o colaborador</h4>
          </div>
        </div>
      </article>

      <article class="card content_textLeft">
        <form action="codigo etica reenviar_aceite2.php" method="post">
          <input type="hidden" value="<?php echo $codigo; ?>" name="idColaborador">
      
          <h5>O email será enviado para: <?php echo $CodigoEtica_Colaborador[3]; ?> </h5>
          <br>
