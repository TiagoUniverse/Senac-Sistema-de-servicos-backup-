 ...
 * ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
 * ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
 * ║  │ @description: Result of the creation of the 'Nivel de acesso' class                                         |  ║
 * ║  │ @class: NivelDeAcesso_cadastro2                                                                             │  ║
 * ║  │ @dir: Src/ View                                                                                      │  ║
...
if ($nome == "") {
  ...
  */
  ...
  $NivelDeAcesso = $NivelDeAcesso_repositorio->cadastro($NivelDeAcesso);
}
...
<body>
  ...
  ?>
    ...
    <section>
      <article class="card">
        <a href="NivelDeAcesso-tela-inicial.php">Voltar ao menu inicial</a>
        <div class="row g-0 text-center">
          <div class="col-6 col-md-4">
            <img src="../../Assets/Img/sistema-operacional.png" alt="Icone da solicitação de acesso" width="200" height="200" id="content_icon">
          </div>
