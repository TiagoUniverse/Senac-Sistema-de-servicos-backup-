...
* ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
* ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
* ║  │ @description: Alteration of informations of 'Nivel de acesso' class                                         │  ║
* ║  │ @class: NivelDeAcesso_alterar                                                                               │  ║
* ║  │ @dir:  View/                                                                                                │  ║
* ║  │ @date: 14/11/22                                                                                             │  ║
* ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
* ║═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
...
$codigo = $_POST['id_NivelDeAcesso2'] ?? $_GET['id_NivelDeAcesso2'];
...
$NivelDeAcesso = $NivelDeAcesso_repositorio->consultaId($codigo);
...
<head>
  ...
  <title>Alterar um nível de acesso</title>
      ...
      <article class="card">
        ...
        <div class="row g-0 text-center">
          ...
          <div class="col-sm-6 col-md-8" id="content_inicio">
            <h2 class="content_inicioText">Alteração de um nível de acesso</h2>
          </div>
        </div>
      </article>

      <article class="card content_inicioText">
        <form action="NivelDeAcesso_alterar2.php" method="POST">
          <?php
          // Se quiser testar, é só alterar a variável pela variável teste
          //$teste = 0;


          if ($NivelDeAcesso->getStatus() == '1') {
          ?>
            <!--Radio button-->
          ...
          <div class="form-floating">
            <input type="text" class="form-control my-2" value="<?php echo $NivelDeAcesso->getNome(); ?>" name="nome" id="nome" placeholder="Nome">
            <label for="floatingPassword">Nome </label>
          </div>

          <br>
          <div class="form-floating">
            <input type="text" class="form-control my-2" value="<?php echo $NivelDeAcesso->getDescricao(); ?>" name="descricao" id="nome" placeholder="Nome">
          ...
          <a class="btn btn-danger" data-bs-toggle="modal" id="button_expanded" data-bs-target="#exampleModal">Alterar</a>
