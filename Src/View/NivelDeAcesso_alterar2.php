...
* ║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
* ║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
* ║  │ @description: Result of the alteration of the 'Nivel de acesso' class                                       |  ║
* ║  │ @class: NivelDeAcesso_alterar2                                                                              │  ║
* ║  │ @dir: Src/ View                                                                                             │  ║
...
if ($nome == "") {
  ...
  */
  ...
  $NivelDeAcesso->setId($id);
  $NivelDeAcesso->setNome($nome);
  $NivelDeAcesso->setDescricao($descricao);
  $NivelDeAcesso->setStatus($status);


  $NivelDeAcesso_repositorio = new NivelDeAcesso_repositorio();

  $NivelDeAcesso = $NivelDeAcesso_repositorio->alterar($NivelDeAcesso);
}
...
<body>
  ...
  ?>
    ...
    ?>
      ...
      <section>
        <article class="card">
          <a href="NivelDeAcesso-tela-inicial.php">Voltar ao menu</a>
        ...
        <article class="card content_inicioText">
          ...
          <div class="row g-0 text-center">
            <div class="col-sm-6 col-md-12">
              ...
              <a class="btn btn-info my-1" id="" href="NivelDeAcesso-tela-inicial.php" role="button">Menu inicial</a>
            </div>
          </div>
